...
export default function Header() {
    let pages = ['Home', 'Auctions', 'Marketplace', 'Drop']
    
    let currentPath = useLocation().pathname.split("/")
    let targetPath = currentPath[currentPath.length-1]
   ...
   const openMenu =()=>{
    ...
    return(
        <>
            {
                pages.includes(targetPath)?
                <>
                    <div className="w-full flex justify-evenly md:justify-around items-center py-[2.2rem]">
                        <div className="w-[25%] flex pl-4 lg:hidden"><img alt="" src={menu} className="w-[30%] sm:w-[20%] text-xl" onClick={()=>openMenu()} /></div>
                        <h4 className="w-[50%] lg:w-[20%] text-center font-[STIXTwoTextBold] uppercase text-3xl sm:text-4xl lg:text-[3vw] text-[#333333]">Artsy.</h4>
                        ...
                        <div className="w-[25%] lg:w-[15%] flex justify-evenly">
                            <img alt="" src={search} className="w-[20%] sm:w-[15%]" />
                            <img alt="" src={cart} className="w-[20%] sm:w-[15%]" />
                            <img alt="" src={alert} className="w-[20%] hidden lg:block sm:w-[15%]" />
                        </div>
                    </div>
