...
export default class Home extends React.Component{
    componentDidMount(){
        ...
        carousel.item(1).getElementsByClassName('leaf').item(0).scrollIntoView();
        carousel.item(2).getElementsByClassName('girl').item(0).scrollIntoView();
        carousel.item(3).getElementsByClassName('kangaroo').item(0).scrollIntoView();
        carousel.item(4).getElementsByClassName('berry').item(0).scrollIntoView();
        ...
        var cimg = document.getElementsByClassName('onecarouselImg');
        var timg = document.getElementsByClassName('twocarouselImg');
        ...
        return (
            <div>
                <div className="w-full">
                    <h1 className='container mx-auto text-[7vw] sm:text-[5vw] mb-[8%] font-[ClashDisplaySemiBold] text-center leading-relaxed'>
